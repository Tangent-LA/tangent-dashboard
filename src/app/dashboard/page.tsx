...
import { calculateStats, filterProjects, exportToExcel, prepareProjectsForExport, cn } from '@/lib/utils';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="h-80">
            {stats && (
              <StageChart 
                ...
                onClick={(stage) => handleChartClick('stage', stage)}
              />
            )}
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="h-80">
            {stats && (
              <PriorityChart 
                data={stats.projectsByPriority}
                onClick={(priority) => handleChartClick('priority', priority)}
              />
            )}
          </div>
        </motion.div>
